...
import type { ShgRolGuildFeature } from "@/types/database";

const EMPTY = { title: "", description: "", benefit: "", unlocked: false, sort_order: "0" };

export function GuildFeaturesManager() {
  ...
  const load = React.useCallback(async () => {
    setLoading(true);
    const res = await fetch("/api/admin/rol/guild-features");
